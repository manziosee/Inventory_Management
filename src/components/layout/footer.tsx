        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Professional inventory management system for modern organizations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/inventory" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Inventory Management
                </Link>
              </li>
              <li>
                <Link to="/borrowing" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Asset Borrowing
                </Link>
              </li>
              <li>
                <Link to="/damage-reports" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Damage Reports
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/faq" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  FAQ
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-base text-gray-400 dark:text-gray-500">
              &copy; {currentYear} AssetFlow. All rights reserved.
            </p>
